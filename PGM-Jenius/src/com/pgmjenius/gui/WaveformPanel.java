...
import com.pgmjenius.audio.Marker;
import com.pgmjenius.audio.Markers;
import com.pgmjenius.audio.Sample;
import com.pgmjenius.audio.Slicer;
...
public class WaveformPanel extends JPanel {
	...
	public void export(String prefix) throws Exception {
		...
		for (int i = 0; i < slices.size() && i < 64; i++) {
			...
			final com.pgmjenius.pgm.Layer layer0 = pad.getLayer(0);
