...
import com.pgmjenius.gui.BaseFrame;
import com.pgmjenius.gui.MainFrame;
import com.pgmjenius.gui.Preferences;
...
public final class PGMJenius {
	...
	public static final void makeAsNativeAsPossible() {
		...
		try {
			if (isMacOsX()) {
				...
				System.setProperty("com.apple.mrj.application.apple.menu.about.name", "PGM-Jenius");
			}
		} catch (Exception e) {
		}
		try {
	...
	public static final void showHelp() {
		System.err.println("Usage: pgm-jenius [-h] [-n] [<program.pgm>]");
		System.err.println();
