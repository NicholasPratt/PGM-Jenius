...
import com.pgmjenius.pgm.Profile;
...
public final class MainFrame extends BaseFrame {
	...
	private static final String HELP_URL = "https://github.com/your-org/PGM-Jenius";
	...
	public void makeAboutDialog() {
		...
		aboutBox = new JDialog(this, "About PGM-Jenius");
		...
		// aboutBox.getContentPane().add(new JLabel("PGM-Jenius", JLabel.CENTER));
	...
	public void makePrefsDialog() {
		// Preferences dialog
		prefs = new JDialog(this, "PGM-Jenius Preferences");
		...
		// contentPane.add(new JLabel("PGM-Jenius Preferences", JLabel.CENTER),
		// BorderLayout.NORTH);
	...
	public String toString() {
		return "PGMJeniusFrame pgm: " + program + " pgmFile: " + pgmFile + " current pad: " + selectedPad;
	}
